...
: "${GOOGLE_CLIENT_ID_SECRET:=GOOSE_AEO_DASHBOARD_GOOGLE_CLIENT_ID}"
: "${GOOGLE_CLIENT_SECRET_SECRET:=GOOSE_AEO_DASHBOARD_GOOGLE_CLIENT_SECRET}"
: "${SESSION_SECRET_SECRET:=GOOSE_AEO_DASHBOARD_SESSION_SECRET}"
: "${ALLOWED_EMAIL_DOMAIN_SECRET:=GOOSE_AEO_DASHBOARD_ALLOWED_EMAIL_DOMAIN}"
: "${BASE_URL_SECRET:=GOOSE_AEO_DASHBOARD_BASE_URL}"
...
DASHBOARD_SECRETS=(
  ...
  "GOOSE_AEO_DASHBOARD_GOOGLE_CLIENT_ID=${GOOGLE_CLIENT_ID_SECRET}:latest"
  "GOOSE_AEO_DASHBOARD_GOOGLE_CLIENT_SECRET=${GOOGLE_CLIENT_SECRET_SECRET}:latest"
  "GOOSE_AEO_DASHBOARD_SESSION_SECRET=${SESSION_SECRET_SECRET}:latest"
  "GOOSE_AEO_DASHBOARD_BASE_URL=${BASE_URL_SECRET}:latest"
)

echo "Deploying public dashboard service with Google Workspace auth..."
